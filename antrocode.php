...
<div id="container">
    <div id="left">
        <img id="gif" src="guy.gif" alt="Default GIF" width="100%" height="50%">
    </div>
    <div id="right" s>
        <div id="output">
            <div class="answer"><p style="padding: 10px">Hey! Ik ben Chat-Bob, waar wil je het over hebben?</p></div>
        </div>
...
<script>
    ...
    function inputPython() {
        ...
        gifElement.classList.add('denkend');
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                // Return Gif to normal
                gifElement.src = "guy.gif";
                gifElement.classList.remove('denkend');
            }
        };
        xhr.open("GET", "antrophp.php?input=" + encodeURIComponent(userInput), true);
        xhr.send();
    }
</script>
